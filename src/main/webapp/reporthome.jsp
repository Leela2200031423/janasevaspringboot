...
<head>
    <meta charset="UTF-8">
    <title>Jana SevaAP - Report Dashboard</title>
            ...
            <div class="complaints-section">
                <div class="complaint-card">
                    ...
                    <div class="complaint-content">
                        ...
                        <button class="details-button" onclick="window.location.href='addreport'">Report</button>
                    </div>
                </div>
                ...
                <div class="complaint-card">
                    <img src="Resources/images/others.jpeg" alt="Medical Facilities" class="complaint-image">
                    <div class="complaint-content">
                        <h3>Other Issues that to Addressed</h3>
                        <p>Her ypu can mention the other issues apart from issues related to roads and hospitals.</p>
                        <button class="details-button" onclick="window.location.href='addreport'">Report</button>
                    </div>
                </div>
            </div>
